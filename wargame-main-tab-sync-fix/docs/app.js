...
function bindEvents() {
  ...
  document.addEventListener('input', (e) => {
    ...
    if (['assetName','assetType','assetAffiliation','assetRepresentation','assetStatus','assetTrackQuality','assetZone','assetAssignedCell','assetHeading','assetSpeed','assetLat','assetLon','assetFuel','assetReadiness','assetWaypoints'].includes(id)) {
  ...
  document.addEventListener('change', (e) => {
    ...
    if (['assetType','assetAffiliation','assetRepresentation','assetStatus','assetTrackQuality','assetZone','assetAssignedCell'].includes(id)) {
