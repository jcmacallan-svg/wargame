...
const ASSET_PROFILE_OPTIONS = [
  { value: '', label: 'No profile / generic baseline', baseType: 'all' },
  { value: 'frigate_general', label: 'General Purpose Frigate', baseType: 'frigate', faction: 'Generic', roleTags: ['General Purpose', 'Escort'], defaultAffiliation: 'friend', readiness: 90, fuel: 100, fuelCapacity: 13, sensorProfile: { radar: 18, visual: 10, inspection: 0.7, ew: 12 }, notes: 'Balanced frigate baseline for generic escort and presence tasks.' },
  { value: 'frigate_air_defence', label: 'Air Defence Frigate', baseType: 'frigate', faction: 'Generic', roleTags: ['AAW', 'Escort', 'Command'], defaultAffiliation: 'friend', readiness: 92, fuel: 100, fuelCapacity: 14, sensorProfile: { radar: 23, visual: 10, inspection: 0.7, ew: 16 }, notes: 'Frigate profile with stronger air-search and area-defence picture.' },
  { value: 'frigate_asw', label: 'ASW Frigate', baseType: 'frigate', faction: 'Generic', roleTags: ['ASW', 'Escort'], defaultAffiliation: 'friend', readiness: 91, fuel: 100, fuelCapacity: 13, sensorProfile: { radar: 17, visual: 10, inspection: 0.7, ew: 13 }, notes: 'Escort profile tuned for anti-submarine warfare and screen duty.' },
  { value: 'corvette_patrol', label: 'Patrol Corvette', baseType: 'corvette', faction: 'Generic', roleTags: ['Patrol', 'Littoral Security'], defaultAffiliation: 'friend', readiness: 88, fuel: 100, fuelCapacity: 11, sensorProfile: { radar: 14, visual: 10, inspection: 0.8, ew: 8 }, notes: 'Compact combatant for littoral security and patrol missions.' },
  { value: 'corvette_missile', label: 'Missile Corvette', baseType: 'corvette', faction: 'Generic', roleTags: ['Strike', 'Littoral'], defaultAffiliation: 'hostile', readiness: 85, fuel: 100, fuelCapacity: 11, sensorProfile: { radar: 15, visual: 10, inspection: 0.6, ew: 10 }, notes: 'Missile-armed small combatant with a stronger surface strike profile.' },
  { value: 'destroyer_multimission', label: 'Multi-Mission Destroyer', baseType: 'destroyer', faction: 'Generic', roleTags: ['AAW', 'ASW', 'Surface Action'], defaultAffiliation: 'friend', readiness: 94, fuel: 100, fuelCapacity: 14, sensorProfile: { radar: 24, visual: 10, inspection: 0.8, ew: 18 }, notes: 'Modern multi-mission destroyer baseline comparable to high-end fleet escorts.' },
  { value: 'destroyer_air_defence', label: 'Air Defence Destroyer', baseType: 'destroyer', faction: 'Generic', roleTags: ['AAW', 'Area Air Defence', 'Escort'], defaultAffiliation: 'friend', readiness: 95, fuel: 100, fuelCapacity: 14, sensorProfile: { radar: 25, visual: 10, inspection: 0.7, ew: 17 }, notes: 'Air-defence destroyer with a stronger wide-area sky surveillance profile.' },
  { value: 'destroyer_strike', label: 'Strike Destroyer', baseType: 'destroyer', faction: 'Generic', roleTags: ['Strike', 'Escort', 'ASuW'], defaultAffiliation: 'hostile', readiness: 89, fuel: 100, fuelCapacity: 14, sensorProfile: { radar: 21, visual: 10, inspection: 0.7, ew: 15 }, notes: 'Destroyer profile leaning toward surface strike and command tasks.' },
  { value: 'cruiser_command', label: 'Command Cruiser', baseType: 'cruiser', faction: 'Generic', roleTags: ['Command', 'Area Air Defence'], defaultAffiliation: 'friend', readiness: 90, fuel: 100, fuelCapacity: 15, sensorProfile: { radar: 24, visual: 10, inspection: 0.6, ew: 17 }, notes: 'Large surface combatant with command-and-control emphasis.' },
  { value: 'cruiser_strike', label: 'Strike Cruiser', baseType: 'cruiser', faction: 'Generic', roleTags: ['Strike', 'Command'], defaultAffiliation: 'hostile', readiness: 82, fuel: 100, fuelCapacity: 15, sensorProfile: { radar: 22, visual: 10, inspection: 0.5, ew: 14 }, notes: 'Heavy strike-oriented cruiser profile with legacy but potent capabilities.' },
  { value: 'carrier_fleet', label: 'Fleet Carrier', baseType: 'aircraft_carrier', faction: 'Generic', roleTags: ['Carrier', 'Air Power', 'Command'], defaultAffiliation: 'friend', readiness: 95, fuel: 100, fuelCapacity: 18, sensorProfile: { radar: 22, visual: 11, inspection: 0.6, ew: 18 }, notes: 'Large-deck carrier profile for fleet aviation and command.' },
  { value: 'carrier_light', label: 'Light Carrier / Aviation Ship', baseType: 'aircraft_carrier', faction: 'Generic', roleTags: ['Aviation', 'Command'], defaultAffiliation: 'friend', readiness: 90, fuel: 100, fuelCapacity: 16, sensorProfile: { radar: 18, visual: 11, inspection: 0.6, ew: 14 }, notes: 'Smaller aviation ship or light carrier profile.' },
  { value: 'submarine_attack', label: 'Attack Submarine', baseType: 'attack_submarine', faction: 'Generic', roleTags: ['Subsurface', 'Ambush', 'ASuW'], defaultAffiliation: 'hostile', readiness: 84, fuel: 100, fuelCapacity: 12, sensorProfile: { radar: 6, visual: 5, inspection: 0.2, ew: 6 }, notes: 'Attack submarine profile for ambush and sea-denial tasks.' },
  { value: 'submarine_ssbn', label: 'Ballistic Missile Submarine', baseType: 'ballistic_missile_submarine', faction: 'Generic', roleTags: ['Strategic Deterrent', 'Subsurface'], defaultAffiliation: 'hostile', readiness: 88, fuel: 100, fuelCapacity: 14, sensorProfile: { radar: 5, visual: 4, inspection: 0.1, ew: 7 }, notes: 'Strategic submarine profile with low observability and endurance bias.' },
  { value: 'patrol_opv', label: 'Offshore Patrol Vessel', baseType: 'patrol_vessel', faction: 'Generic', roleTags: ['Patrol', 'Maritime Security', 'Presence'], defaultAffiliation: 'friend', readiness: 88, fuel: 100, fuelCapacity: 12, sensorProfile: { radar: 16, visual: 11, inspection: 0.9, ew: 8 }, notes: 'Patrol and maritime security baseline with strong boarding utility.' },
  { value: 'amphib_transport', label: 'Amphibious Transport Dock', baseType: 'amphibious_ship', faction: 'Generic', roleTags: ['Amphibious', 'Sealift', 'Command Support'], defaultAffiliation: 'hostile', readiness: 85, fuel: 100, fuelCapacity: 15, sensorProfile: { radar: 14, visual: 10, inspection: 0.7, ew: 10 }, notes: 'Amphibious transport profile for lift and command support.' },
  { value: 'amphib_assault', label: 'Amphibious Assault Ship / LHD', baseType: 'amphibious_assault_ship', faction: 'Generic', roleTags: ['Amphibious Assault', 'Aviation', 'Command'], defaultAffiliation: 'hostile', readiness: 89, fuel: 100, fuelCapacity: 16, sensorProfile: { radar: 18, visual: 10, inspection: 0.7, ew: 12 }, notes: 'Aviation-capable amphibious assault profile.' },
  { value: 'replenishment_fleet', label: 'Fleet Replenishment Ship', baseType: 'replenishment_ship', faction: 'Generic', roleTags: ['Logistics', 'Sustainment'], defaultAffiliation: 'friend', readiness: 86, fuel: 100, fuelCapacity: 17, sensorProfile: { radar: 12, visual: 10, inspection: 0.8, ew: 6 }, notes: 'Replenishment profile to support sustained fleet operations.' },
  { value: 'intelligence_agi', label: 'Intelligence / AGI Ship', baseType: 'intelligence_ship', faction: 'Generic', roleTags: ['ISR', 'SIGINT', 'Presence'], defaultAffiliation: 'suspect', readiness: 84, fuel: 100, fuelCapacity: 14, sensorProfile: { radar: 15, visual: 10, inspection: 0.5, ew: 17 }, notes: 'Signals-collection and maritime ISR profile.' }
];

const ASSET_PROFILE_LIBRARY = Object.fromEntries(ASSET_PROFILE_OPTIONS.filter(item => item.value).map(item => [item.value, item]));

const LEGACY_CLASS_PRESET_MAP = {
  arleigh_burke_ddg: 'destroyer_multimission',
  type_45_ddg: 'destroyer_air_defence',
  de_zeven_provincien_lcf: 'frigate_air_defence',
  fremm_frigate: 'frigate_asw',
  holland_opv: 'patrol_opv',
  queen_elizabeth_carrier: 'carrier_fleet',
  admiral_gorshkov_frigate: 'destroyer_strike',
  admiral_grigorovich_frigate: 'frigate_general',
  project_636_submarine: 'submarine_attack',
  slava_cruiser: 'cruiser_strike',
  type_052d_destroyer: 'destroyer_multimission',
  type_055_destroyer: 'cruiser_command',
  type_054a_frigate: 'frigate_general',
  type_071_amphib: 'amphib_transport',
  type_075_lhd: 'amphib_assault'
};
...
const NAVAL_CLASS_LIBRARY = ASSET_PROFILE_OPTIONS.filter(item => item.value);
...
function profilePresetForAsset(assetOrType, explicitProfileKey = '') {
  if (assetOrType && typeof assetOrType === 'object') {
    const direct = assetOrType.profileKey || explicitProfileKey || '';
    if (direct && ASSET_PROFILE_LIBRARY[direct]) return ASSET_PROFILE_LIBRARY[direct];
    const legacy = LEGACY_CLASS_PRESET_MAP[assetOrType.type || ''];
    if (legacy && ASSET_PROFILE_LIBRARY[legacy]) return ASSET_PROFILE_LIBRARY[legacy];
    return null;
  }
  const direct = explicitProfileKey || '';
  if (direct && ASSET_PROFILE_LIBRARY[direct]) return ASSET_PROFILE_LIBRARY[direct];
  const legacy = LEGACY_CLASS_PRESET_MAP[assetOrType || ''];
  if (legacy && ASSET_PROFILE_LIBRARY[legacy]) return ASSET_PROFILE_LIBRARY[legacy];
  return null;
}
function modernPresetForType(type) {
  return profilePresetForAsset(type) || NAVAL_CLASS_LIBRARY_BY_KEY[normalizeAssetType(type)] || null;
}
function roleTagsForAsset(asset) {
  return Array.isArray(asset?.roleTags) && asset.roleTags.length ? asset.roleTags : (profilePresetForAsset(asset)?.roleTags || modernPresetForType(asset?.type)?.roleTags || []);
}
function fuelCapacityForAsset(asset) {
  const preset = profilePresetForAsset(asset) || modernPresetForType(asset?.type);
...
function profileOptionsForType(type) {
  const normalized = normalizeAssetType(type);
  return ASSET_PROFILE_OPTIONS.filter(item => !item.value || item.baseType === 'all' || item.baseType === normalized);
}
function assetProfileLabel(profileKey) {
  return ASSET_PROFILE_LIBRARY[profileKey]?.label || 'Generic baseline';
}
...
function renderModernAssetLibraryInfo() {
  ...
  if (!select.options.length) {
    select.innerHTML = NAVAL_CLASS_LIBRARY.map(item => `<option value="${item.value}">${assetTypeLabel(item.baseType)} · ${item.label}</option>`).join('');
  }
  const preset = NAVAL_CLASS_LIBRARY_BY_KEY[select.value] || NAVAL_CLASS_LIBRARY.find(item => item.value) || NAVAL_CLASS_LIBRARY[0];
  if (!preset) { panel.innerHTML = ''; return; }
  const tags = (preset.roleTags || []).map(tag => `<span class="tag">${tag}</span>`).join(' ');
  panel.innerHTML = `
    <div class="card" style="margin-top:8px">
      <strong>${assetTypeLabel(preset.baseType)} · ${preset.label}</strong>
      <div class="row" style="margin-top:6px">
        <span class="tag">${preset.faction || 'Generic profile'}</span>
        <span class="tag">${assetTypeLabel(preset.baseType)}</span>
        <span class="tag">Suggested affiliation: ${assetAffiliationLabel(preset.defaultAffiliation || preset.affiliation || 'friend')}</span>
...
function migrateState(pkg) {
  ...
  merged.assets = merged.assets.map(a => {
    const legacyProfileKey = LEGACY_CLASS_PRESET_MAP[a?.type || ''] || '';
    const normalizedType = normalizeAssetType(legacyProfileKey ? (ASSET_PROFILE_LIBRARY[legacyProfileKey]?.baseType || a?.type) : a?.type);
    const preset = profilePresetForAsset(a, legacyProfileKey) || modernPresetForType(normalizedType);
    ...
    return Object.assign({
      ...
      readiness: 100,
      profileKey: legacyProfileKey || a?.profileKey || '',
...
function normalizeAssetType(type) {
  ...
  const profileMapped = LEGACY_CLASS_PRESET_MAP[type || ''];
  if (profileMapped && ASSET_PROFILE_LIBRARY[profileMapped]) return ASSET_PROFILE_LIBRARY[profileMapped].baseType;
...
function bindEvents() {
  ...
  bindChange('assetProfile', onSelectedAssetProfileChanged);
  ...
  document.addEventListener('input', (e) => {
    ...
    if (['scenarioNameInput', 'scenarioOverviewInput', 'scenarioSituationInput', 'turnDurationHoursInput'].includes(id)) {
      debouncedSaveScenarioMeta();
      return;
    }
    if (e.target?.closest?.('#cellsEditor')) {
      debouncedSaveCells();
      return;
    }
    if (['assetName','assetType','assetProfile','assetAffiliation','assetRepresentation','assetStatus','assetTrackQuality','assetZone','assetAssignedCell','assetHeading','assetSpeed','assetLat','assetLon','assetFuel','assetReadiness','assetWaypoints'].includes(id)) {
      debouncedSaveSelectedAssetProps();
    }
  });
  document.addEventListener('change', (e) => {
    const id = e.target?.id || '';
    if (['overlaySelect', 'symbolStyleSelect', 'turnDurationUnitSelect', 'rememberLastMapView'].includes(id)) {
      saveScenarioMeta();
      if (id === 'overlaySelect' || id === 'symbolStyleSelect') initMaps(true);
      return;
    }
    if (e.target?.closest?.('#cellsEditor')) {
      saveCells();
    ...
    if (['assetType','assetProfile','assetAffiliation','assetRepresentation','assetStatus','assetTrackQuality','assetZone','assetAssignedCell'].includes(id)) {
      saveSelectedAssetProps();
    }
  });
}
...
const debouncedSaveScenarioMeta = debounce(saveScenarioMeta, 200);
const debouncedSaveCells = debounce(saveCells, 250);
const debouncedSaveSelectedAssetProps = debounce(saveSelectedAssetProps, 250);
...
function saveCells() {
  ...
  const cells = rows.map((row, idx) => {
    ...
    let id = existing?.id || uniqueId(name, Array.from(usedIds));
    while (usedIds.has(id)) id = uniqueId(name, Array.from(usedIds));
    usedIds.add(id);
    return { id, name, domain: row.querySelector('.cell-domain').value, lat: existing?.lat ?? fallback[0], lon: existing?.lon ?? fallback[1] };
  });
...
function createAssetBase(type, overrides = {}) {
  ...
  return {
    ...
    profileKey: overrides.profileKey != null ? overrides.profileKey : '',
    roleTags: Array.isArray(overrides.roleTags) ? clone(overrides.roleTags) : clone((profilePresetForAsset(null, overrides.profileKey)?.roleTags) || (modernPresetForType(normalizedType)?.roleTags || [])),
    faction: overrides.faction != null ? overrides.faction : ((profilePresetForAsset(null, overrides.profileKey)?.faction) || (modernPresetForType(normalizedType)?.faction || '')),
    classNotes: overrides.classNotes != null ? overrides.classNotes : ((profilePresetForAsset(null, overrides.profileKey)?.notes) || (modernPresetForType(normalizedType)?.notes || '')),
    sensorProfile: Object.assign({}, (profilePresetForAsset(null, overrides.profileKey)?.sensorProfile) || modernPresetForType(normalizedType)?.sensorProfile || defaultSensorProfileForAssetType(normalizedType), overrides.sensorProfile || {}),
...
function addModernAssetFromLibrary() {
  const select = document.getElementById('modernAssetLibrarySelect');
  if (!select?.value) {
    alert('Choose a generic ship class / profile first.');
    return;
  }
  const preset = NAVAL_CLASS_LIBRARY.find(item => item.value === select.value);
  if (!preset) return;
  const baseType = preset.baseType || 'patrol_vessel';
  const asset = createAssetBase(baseType, {
    profileKey: preset.value,
    affiliation: preset.defaultAffiliation || preset.affiliation || 'friend',
    assignedCell: preset.assignedCell || '',
    speed: preset.speed || defaultSpeedForAssetType(baseType),
    readiness: preset.readiness,
    fuel: preset.fuel,
    fuelCapacity: preset.fuelCapacity,
    heading: preset.heading || 90,
    sensorProfile: clone(preset.sensorProfile || {}),
    roleTags: clone(preset.roleTags || []),
    faction: preset.faction || '',
    classNotes: preset.notes || ''
  });
  asset.name = autoNameForAssetType(baseType, state.assets.map(a => a.name));
  asset.type = baseType;
...
function onSelectedAssetTypeChanged() {
  ...
  const profileEl = document.getElementById('assetProfile');
  if (profileEl) {
    const currentProfile = asset?.profileKey || '';
    profileEl.innerHTML = profileOptionsForType(type).map(o => `<option value="${o.value}">${o.label}</option>`).join('');
    profileEl.value = profileOptionsForType(type).some(o => o.value === currentProfile) ? currentProfile : '';
  }
  if (asset) {
    if (asset.profileKey && !profileOptionsForType(type).some(o => o.value === asset.profileKey)) asset.profileKey = '';
    const preset = profilePresetForAsset(asset) || modernPresetForType(type);
...
function onSelectedAssetProfileChanged() {
  const asset = state.assets.find(a => a.id === state.selectedAssetId);
  const profileEl = document.getElementById('assetProfile');
  if (!profileEl || !asset) return;
  asset.profileKey = profileEl.value || '';
  const preset = profilePresetForAsset(asset);
  if (!preset) {
    asset.roleTags = [];
    asset.classNotes = '';
    asset.sensorProfile = Object.assign({}, defaultSensorProfileForAssetType(asset.type));
    asset.fuelCapacity = defaultFuelCapacityForAssetType(asset.type);
    renderModernAssetLibraryInfo();
    return;
  }
  asset.roleTags = clone(preset.roleTags || []);
  asset.classNotes = preset.notes || '';
  asset.sensorProfile = Object.assign({}, preset.sensorProfile || defaultSensorProfileForAssetType(asset.type));
  asset.fuelCapacity = preset.fuelCapacity || defaultFuelCapacityForAssetType(asset.type);
  if (!String(document.getElementById('assetFuel')?.value || '').trim()) asset.fuel = clampPercent(preset.fuel, 100);
  if (!String(document.getElementById('assetReadiness')?.value || '').trim()) asset.readiness = clampPercent(preset.readiness, 100);
  const fuelEl = document.getElementById('assetFuel');
  const readinessEl = document.getElementById('assetReadiness');
  if (fuelEl) fuelEl.title = `Fuel remaining in percent; 100% equals ${fuelCapacityForAsset(asset)} endurance units for this class`; 
  if (readinessEl) readinessEl.title = 'Operational readiness percentage';
  renderModernAssetLibraryInfo();
}
...
function saveSelectedAssetProps() {
  ...
  asset.profileKey = document.getElementById('assetProfile')?.value || '';
  ...
  asset.roleTags = clone(preset?.roleTags || asset.roleTags || []);
  asset.classNotes = preset?.notes || asset.classNotes || '';
  asset.sensorProfile = Object.assign({}, defaultSensorProfileForAssetType(asset.type), preset?.sensorProfile || {}, asset.sensorProfile || {});
...
function renderFacilitatorMap() {
  ...
  state.assets.forEach((a, idx) => {
    ...
    marker.bindPopup('<strong>' + a.name + '</strong><br>Display: ' + assetRepresentationLabel(a.representation) + '<br>Type: ' + assetTypeLabel(a.type) + '<br>Affiliation: ' + assetAffiliationLabel(a.affiliation) + '<br>Track quality: ' + trackQualityLabel(a.trackQuality) + '<br>Heading: ' + normalizeHeading(a.heading) + '&deg;<br>Speed: ' + normalizeSpeed(a.speed) + ' kt<br>Profile: ' + assetProfileLabel(a.profileKey) + '<br>Fuel: ' + fuelPercentLabel(a) + ' (' + fuelCapacityForAsset(a).toFixed(0) + 'u cap)<br>Readiness: ' + readinessPercentLabel(a) + '<br>Waypoints: ' + waypointSummary(a) + '<br>Zone: ' + prettyZone(a.zone) + '<br>Group: ' + assetOwningGroupLabel(a));
      ...
      ${section.assets.map(a => `
        <div class="card asset ${a.id === state.selectedAssetId ? 'zone-selected' : ''}">
          ...
          <div class="row" style="margin-top:6px">
            ...
            <span class="tag">${assetTypeLabel(a.type)}</span><span class="tag">${assetProfileLabel(a.profileKey)}</span>
...
function renderAssetEditor() {
  ...
  const assetProfile = document.getElementById('assetProfile');
  ...
  if (assetProfile) assetProfile.innerHTML = profileOptionsForType(asset?.type || 'patrol_vessel').map(o => `<option value="${o.value}">${o.label}</option>`).join('');
  ...
  if (assetProfile) {
    const currentProfile = asset?.profileKey || '';
    assetProfile.innerHTML = profileOptionsForType(asset?.type || 'patrol_vessel').map(o => `<option value="${o.value}">${o.label}</option>`).join('');
    assetProfile.value = profileOptionsForType(asset?.type || 'patrol_vessel').some(o => o.value === currentProfile) ? currentProfile : '';
  }
...
function renderPlayerPage() {
  ...
  document.getElementById('playerAssetsPanel').innerHTML = `
    <div class="asset-section">
      ...
      ${myAssets.length ? myAssets.map(a => `<div class="card ${a.id === playerSelectedAssetId ? 'zone-selected' : ''}"><strong>${a.name}</strong><div class="row"><span class="tag">${assetRepresentationLabel(a.representation)}</span><span class="tag">${assetTypeLabel(a.type)}</span><span class="tag">${assetProfileLabel(a.profileKey)}</span><span class="tag">${assetAffiliationLabel(a.affiliation)}</span><span class="tag">${trackQualityShort(a.trackQuality)}</span><span class="tag">${a.status}</span><span class="tag">${prettyZone(a.zone)}</span><span class="tag">${normalizeHeading(a.heading)}° / ${normalizeSpeed(a.speed)} kt</span><span class="tag">${waypointSummary(a)}</span><span class="tag">Fuel ${fuelPercentLabel(a)}</span><span class="tag">Ready ${readinessPercentLabel(a)}</span></div>${(!isCommercialAssetType(a.type) && normalizeAssetAffiliation(a.affiliation) !== 'neutral') ? `<button class="secondary player-select-btn" onclick="selectPlayerAsset('${a.id}')">Select</button>` : `<div class="small" style="margin-top:8px">Facilitator-controlled contact. Visible, but not movable from player view.</div>`}</div>`).join('') : '<div class="small">No assets assigned to this cell yet.</div>'}
    </div>`;
